...
namespace EasyBuildSystem.Packages.Addons.CircularBuildingMenu.Editor
{
    ...
    public class UICircularBuildingMenuEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUIUtilityExtension.DrawHeader("Easy Build System - UI Circular Building Menu",
                "This component allow to quickly and easily select different building modes and Building Parts.\n" +
                "You can find more information about this add-on in the documentation.");

            EditorGUILayout.HelpBox("UI Circular Building Menu can update automatically after each change.\n" +
                "You can also Unpack Prefab to break the connection with the root prefab during modifications, refreshing the menu during edit-time.", MessageType.Info);

...
namespace EasyBuildSystem.Features.Runtime.Buildings.Placer.InputHandler
{
    public class StandaloneInputHandler : BaseInputHandler
    {
        ...
        public class InputSettings
        {
            ...
            public InputActionReference ValidateInputReference { get { return m_ValidateInputReference; } }

            [SerializeField] InputActionReference m_CancelInputReference;
            public InputActionReference CancelInputReference { get { return m_CancelInputReference; } }
            ...
            public InputActionReference RotateModeInputReference { get { return m_RotateModeInputReference; } }
            ...
            public InputActionReference SelectInputReference { get { return m_SelectInputReference; } }
            ...
            public InputActionReference PlacingModeInputReference { get { return m_PlacingModeInputReference; } }
            ...
            public InputActionReference EditingModeInputReference { get { return m_EditingModeInputReference; } }
            ...
            public InputActionReference DestroyingModeInputReference { get { return m_DestroyingModeInputReference; } }
        ...
        void HandlePlacingMode()
        {
            ...
            if (m_InputSettings.CanRotateBuildingPart)
            {
                ...
                {
                    float wheelAxis = m_InputSettings.RotateModeInputReference.action.ReadValue<float>();
        ...
        void HandleBuildingPartSelection()
        {
            ...
            {
                if (m_InputSettings.SelectInputReference.action.triggered)
                {
        ...
        void HandlePlacingMode()
        {
            ...
            if (m_InputSettings.CanRotateBuildingPart)
            {
                float wheelAxis = player.GetAxis(m_InputSettings.RotateActionName);

...
namespace EasyBuildSystem.Features.Runtime.Buildings.Placer
{
    ...
    public class BuildingPlacer : MonoBehaviour
    {
        ...
        void HandleFree()
        {
                ...
                m_RaycastSettings.GetRaycastDistance, m_RaycastSettings.LayerMask))
            {
                ...
                if (m_CurrentPreview.GetPreviewSettings.RotateAccordingAngle)
                {
                    ...
                    m_CurrentPreview.transform.rotation = rotationBasedOnAxis;
                }
        ...
        Vector3 GetLookDistance()
        {
            ...
            {
                lookDistance.y = Mathf.Clamp(lookDistance.y, -m_CurrentPreview.GetPreviewSettings.PreviewElevationHeight,
                     m_RaycastSettings.GetCaster.transform.position.y + -m_CurrentPreview.GetPreviewSettings.PreviewElevationHeight);
            }
            else
            {

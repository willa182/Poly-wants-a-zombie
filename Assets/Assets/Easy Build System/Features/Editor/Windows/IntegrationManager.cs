    ...
    public class IntegrationManager : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            AddIntegration("GameCreator V2", "Catsoft Works",
                "https://assetstore.unity.com/packages/tools/game-toolkits/game-creator-2-203069", "EBS_GAMECREATORV2", "GameCreator V2 Integration", "2.12.42", null, null);
        ...
        void AddIntegration(string name, string author, string link, string defName, string packageName, string version, Action onEnable, Action onDisable)
        {
            ...
            if (!HasSymbol(defName))
            {
                if (GUILayout.Button("Enable Integration", GUILayout.Width(130)))
                {
                    ...
                    string relativePath = GetRelativePath(packageName);

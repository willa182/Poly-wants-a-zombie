...
namespace EasyBuildSystem.Features.Runtime.Buildings.Placer.InputHandler.Editor
{
    ...
    public class StandaloneInputHandlerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox("Input System package has been detected in this project.\n" +
                "Please import the latest Input System support via the Package Importer to ensure that the system works!.", MessageType.Warning);
